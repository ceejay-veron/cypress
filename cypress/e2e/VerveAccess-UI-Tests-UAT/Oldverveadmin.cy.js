...
describe('visit Verve Access', () => {
    ...
    it('should Navigate to inactive tab', () => {
     ...
     ///it('should Search for chip type on inactive tab and search', () => {
      ...
      cy.reload()
       ...
       cy.reload()
        ...
        cy.reload()
         ...
         it('should test for url, Navigate to Decals Page and ', () => {
        cy.title().should('eq', 'Verve Access')
        cy.location('protocol').should('eq', 'https:')
        // /cy.contains('Get Started Now').click({timeout : 2000})
      ...
      const yourFixturePath = 'files/verve.jpg';
        ...
        // Create Decals
        Dc.setGoToDecalsPage();
        cy.get('.add-button-container > .d-flx').click()
        //cy.contains('Add File').click({force:true})
        cy.get('span[class="blue"]').click()
        //selectFile(yourFixturePath, {force:true})
 ...
 // Serach by complete Artwork ID on pending tab
     ...
     it('should Navigate to user Report Page and search', () => {
     ...
     it('should Navigate to Decal Page', () => {
   ...
   ////  it('should Navigate to Contact details', () => {
      ...
      cy.reload({timeout : 130000})
        ...
        // View all contact
        Dc.setGoToDecalsPage();
        cy.get('#sidebar > .sidebar-container > #side-nav > .isw-sideBarNav > :nth-child(6) > .isw-sideBarNavLink > .isw-sideBarNavLabel')
     ...
     it.only('should Navigate to Request Page', () => {
     ...
     /* cy.reload({timeout : 130000})
      ...
      const yourFixturePath = 'files/verve.jpg';
        ...
        // Search by  complete Report Title
        cy.get('#burger-cont > :nth-child(3)').click()
        cys.get('#sidebar > .sidebar-container > #side-nav > .isw-sideBarNav > :nth-child(12) > .isw-sideBarNavLink > .isw-sideBarNavLabel').click();
        // should see Request setting
